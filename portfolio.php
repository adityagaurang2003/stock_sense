...
if(isset($_SESSION['loggedin'])){
   $rows = DB::query("SELECT ci.company_name, ci.symbol, t.price, t.date, t.totalprice, t.no_of_share FROM company_info ci LEFT JOIN portfolio as t ON t.company_id=ci.company_id WHERE t.uid=%i", $_SESSION['id']);
 }
?>
</header>
